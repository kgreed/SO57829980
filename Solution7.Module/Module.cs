...
using Solution7.Module.BusinessObjects;

namespace Solution7.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class Solution7Module : ModuleBase {
        static Solution7Module() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<Solution7DbContext>());
            // #endif 
        }
        public Solution7Module() {
            InitializeComponent();
